...
==== Passing environment variables to recipes
...
Just can load an .env file. the variables it contains will be available as environment variables to the recipes.
See here[https://github.com/casey/just#dotenv-integration].

==== Creating just variables from the shell's environment variables

Environment varialbles from the shell can be passed as variables to to just with the functions env_var() and en_var_or_default(), described here[https://github.com/casey/just#environment-variables].
